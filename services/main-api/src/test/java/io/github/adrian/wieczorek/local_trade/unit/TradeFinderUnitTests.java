...
public class TradeFinderUnitTests {
    ...
    public void setUp() {
        ...
        TradeInitiationRequestDto tradeInitiationRequestDto = new TradeInitiationRequestDto(BigDecimal.valueOf(2), advertisementEntity.getAdvertisementId());
    ...
    public void getAllMyTradesWithNoUsers_throwsUserNotFoundException() {
        ...
        Assertions.assertThrows(UserNotFoundException.class, () -> tradeFinder.getAllMyTrades(mockUserDetails));
