...
public class TradeEntityIntegrationTests extends AbstractIntegrationTest {
    ...
    public void setup() {
        ...
        sellerAdvertisementEntity = AdUtils.createAdvertisementRoleUserForIntegrationTests(buyerCategoryEntity, buyer);
    ...
    public void tradeInitiation_thenReturnHttpCodes(String httpMethod, String path, int statusCode) throws Exception {
        TradeInitiationRequestDto tradeInitiation = new TradeInitiationRequestDto(BigDecimal.valueOf(2), sellerAdvertisementEntity.getAdvertisementId());
        ...
        switch (httpMethod.toUpperCase()) {
            case "POST":
                ...
                break;
                case "PATCH":
                    var trade =  TradeEntity.builder()
                            .advertisementEntity(sellerAdvertisementEntity)
            ...
            case"PATCH CANCELLED":
                var mockTrade =  TradeEntity.builder()
                        .advertisementEntity(sellerAdvertisementEntity)
                        .buyerLeftReview(false)
                        .status(TradeStatus.PROPOSED)
                        .createdAt(LocalDateTime.now().minusDays(1))
