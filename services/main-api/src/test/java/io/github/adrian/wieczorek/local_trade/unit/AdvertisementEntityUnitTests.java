...
public class AdvertisementEntityUnitTests {
    ...
    void equals_shouldReturnFalse_whenComparedToDifferentClass() {
        ...
        assertNotEquals(entity1, otherObject, "An object should not be equal to an object of a different type");
    }
    ...
    void equals_shouldReturnFalse_whenIdsAreDifferent() {
        ...
        assertNotEquals(entity1, entity2, "Objects with different advertisementIds should not be equal");
    }
    ...
    void equals_shouldReturnFalse_whenOneIdIsNull() {
        ...
        assertNotEquals(entity1, entity2, "An object with an ID should not be equal to an object with a null ID");
        assertNotEquals(entity2, entity1, "An object with a null ID should not be equal to an object with an ID");
    }
    ...
    void hashCode_contract_whenIdsAreSame() {
        ...
        assertEquals(entity1.hashCode(), entity2.hashCode(), "Equal objects must have the same hashCode");
    }
    ...
    void hashCode_contract_whenIdsAreNull() {
        ...
        assertEquals(entity1.hashCode(), entity2.hashCode(), "Objects with null ID must have the same hashCode");
    }
    ...
    void hashCode_shouldReturnClassHashCode_whenIdIsNull() {
        ...
        assertEquals(expectedHashCode, entity1.hashCode(), "hashCode() should return getClass().hashCode() when ID is null");
    }
}